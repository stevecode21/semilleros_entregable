...
function App() {
  ...
  return (
    <div className="h-screen backgroundimage">
      <nav class="bg-white border-gray-200 px-2 py-4 dark:bg-gray-800">
        <div class="container flex flex-wrap space-x-4 items-center mx-auto">
          {location.pathname !== "/" && (
            <Link to="/" className="bg-white p-2 rounded-md text-white">
              <svg
